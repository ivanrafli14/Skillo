  ...
  <div class="w-full pt-36">
    <div class="mx-auto max-w-7xl px-[calc(3.5vw+5px)]">
      <div class="flex flex-col md:flex-row items-center justify-between gap-6 pb-8">
        <div>
          <img class="w-[90px] rounded-full" src="{{ auth()->user()->photo_url }}"
            alt="John Doe" />
        </div>
        ...
        <div
          class="flex cursor-pointer items-center self-end md:self-auto gap-3 rounded-lg border border-line bg-gray-100 px-3.5 py-2.5 text-sm font-medium transition hover:bg-blue-50">
      ...
      <div class="mb-1.5 flex flex-col rounded-lg border border-line">
        ...
        @if (auth()->user()->status == 'free')
          <div
            class="flex flex-col md:flex-row items-center justify-between gap-3 rounded-b-lg bg-white px-5 py-2.5 text-sm">
            <p class="mr-auto">
        ...
        @else
          <div class="flex items-center rounded-b-lg justify-between bg-white px-5 py-2.5">
            <p class="text-sm">
              <span class="text-primary">Paket
                Premium Tahunan:</span> Akses penuh semua kelas premium
            </p>
            <div class="hidden md:flex items-center justify-center gap-2 py-2 text-sm">
              <img src="{{ asset('assets/time.svg') }}" class="filter-primary"
                alt="time">
      ...
      <!-- Activity Section -->
      <div class="flex md:flex-row flex-col md:gap-7 gap-2">
        <!-- Learning Activity -->
        <div class="flex flex-[1_0_0] flex-col gap-5 py-6">
          ...
          @if ($courseUsers->isEmpty())
            <div
              ...
              <p class="text-center text-sm ">Belum ada Kursus yang
                diikuti.</p>
            </div>
          @endif
        ...
        <div class="flex  flex-[1_0_0] flex-col gap-5 py-6">
          ...
          <div class="grid md:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-5">
            <a href="/event"
